...
func (rf *Raft) checkVoteState() {
	if rf.voteList[rf.me] > len(rf.peers)/2 && rf.role == candidate {
...
func (rf *Raft) sendVoteRequest(peer int) {
...
func (rf *Raft) startElection() {
	...
	// fmt.Println("server  start election", rf.me)
